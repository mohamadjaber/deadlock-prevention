...
\cLFV{$\B_i, \VS, \dsk{\act}{\l}, t_\act$} & true iff $B_i$ has local sc-formation violation \\
& in state $t_\act$ of $\dsk{\act}{\l}$, \ie $\locFormViol{B_i}{t_\act}{\act}{\l}$ holds\\ \hline

\cLconnScV{$\B_i, \VS, \dsk{\act}{\l}, t_\act$} & true iff $B_i$ has local strong connectedness
...
\lio{\FORALLC{\mbox{reachable transitions $s_\act \goesto[\act] t_\act$ of $\dsk{\act}{\l}$}}}
   \litc{\VS \gets \cLFP{\dsk{\act}{\l},t_\act}}{\cmnt see \fig{algcomputeLFP}}
   \lit{\FORALLC{\B_i \in \cmps{\act}}}
      \lihc{\IF\ \neg \cLFV{\B_i, \VS, \dsk{\act}{\l},t_\act}\ \THEN\ \RETURNE{\fff}\ \FI}{\cmnt return $\fff$ if no violation for $\B_i$}
...
\lion{\RETURNE{\B_i \in \VS \, \lor \, \mbox{\cLconnScV{$\B_i, \VS, \dsk{\act}{\l}, t_\act$}}}}
\end{tabbing}
...
aaa\= aa\= aa\= aa\= aa\=\kill
\cLconnScV{$\B_i, \VS, \dsk{\act}{\l}, t_\act$}\\
...
\lio{\mbox{remove from $\lwfg{B}{t_\act}{\DS}$ all nodes in $\VS$, \ie with a local supercycle violation}}
