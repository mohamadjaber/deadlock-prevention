...
In all figures of wait-for graphs, we show compnents in \Bc{red}, interactions in \ac{blue}, 
eges from components to interactions as solid, and edges from interactions to components as dashed.
