...
therein and analyze interactions, ports, components and states. Note also that interactions are the only means of inter-component communication and synchronization in BIP (we clarified this in the paper).  
...
\answer{
We added references to the example of dining philosophers to several definitions. 
