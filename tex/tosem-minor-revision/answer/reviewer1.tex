...
\answer{
It means that "when the port is clear from the context or not needed, we drop it on the transition and write". 
We updated it in the paper. 
}
...
\answer{
We added an example that applies proposisition 2.13 on the dining philosopher model. 
}
...
application on page 32..
  ...
  \answer{We added, in Section 3, an illustration of subsystem and local supercycle to present the local method.} 
