...
\newcommand{\VFi}[2]{\ensuremath{\CMATHIDN{V}^{#2}(#1)}}   % fixpoint mapping for supercycle violation, with superscript for iteration
...
\newcommand{\lVFi}[2]{\ensuremath{\CMATHIDN{VL}^{#2}(#1)}}   % fixpoint mapping for local supercycle violation
