...
\usepackage{graphicx,color,xcolor,xspace}
...
\newcommand{\exm}[1]{Example~\ref{exm:#1}}
...
\newcommand{\actc}{\ensuremath{\mathsf{c}}} 
\newcommand{\actd}{\ensuremath{\mathsf{d}}} 
\newcommand{\acte}{\ensuremath{\mathsf{e}}} 
\newcommand{\actf}{\ensuremath{\mathsf{f}}} 
\newcommand{\actg}{\ensuremath{\mathsf{g}}} 
\newcommand{\acth}{\ensuremath{\mathsf{h}}} 
\newcommand{\acti}{\ensuremath{\mathsf{i}}} 
...
\newcommand{\nodes}[1]{\ensuremath{\MATHID{nodes}(#1)}}  % reachable states
\newcommand{\cnodes}[1]{\ensuremath{\card{\MATHID{nodes}(#1)}}}  % reachable states
\newcommand{\nodesPow}[1]{\ensuremath{\power{\MATHID{nodes}(#1)}}}  % reachable states
...
\newcommand{\lwfgPow}[3]{\ensuremath{\power{\lwfg{#1}{#2}{#3}}}}
\newcommand{\Adj}{\ensuremath{\mathit{Deg}}} % max length of adjacency list in local wfg of D, i.e., out-degree
\newcommand{\Fix}{\ensuremath{\mathit{Fix}}} % number of iterations needed by Compute-LFP to reach a fixpoint


\newcommand{\sD}{\ensuremath{s_\DS}}   %state of local subsystem
\newcommand{\tD}{\ensuremath{t_\DS}}   %state of local subsystem
...
\newcommand{\ndu}{\MATHID{v}} % node in a wait for graph
...
\newcommand{\complLoc}[1]{\ensuremath{\widehat{\MATHIDN{#1}}}} % local 
...
\newcommand{\preds}[3]{\ensuremath{\MATHID{preds}_{#1}({#3, #2})}}
\newcommand{\succs}[3]{\ensuremath{\MATHID{succs}_{#1}({#3, #2})}}


\newcommand{\SC}{\ensuremath{\MATHIDN{SC}}}
\newcommand{\CC}{\ensuremath{\MATHIDN{CC}}}
\newcommand{\SSC}{\ensuremath{\MATHIDN{SSC}}}
...
\newcommand{\DS}{\ensuremath{\mathsf{D}}\xspace}     % deadlock subsystem
\newcommand{\ds}[1]{\ensuremath{\MATHIDN{D}_{#1}}}     % deadlock subsystem
\newcommand{\dsk}[2]{\ensuremath{\SMATHID{D}}}     % generalized deadlock subsystem, with sub/superscripts omitted
\newcommand{\dsks}[2]{\ensuremath{\SMATHID{D}_{#1}^{#2}}}     % generalized deadlock subsystem with sub/superscripts

\newcommand{\QDS}{\ensuremath{Q_0^{\DS}}} % initial states of deadlock subsystem
...
\newcommand{\scVL}[4]{\ensuremath{\SMATHID{violLoc}_{\dsk{#3}{#4}}(#1,#2)}} % local supercycle violation condition
...
\newcommand{\lviol}[5]{\ensuremath{\SMATHID{violLoc}_{\dsk{#4}{#5}}(#1,#3,#2)}} % local supercycle violation condition at depth $d$
\newcommand{\scVLd}[5]{\ensuremath{\SMATHID{violLoc}_{\dsk{#4}{#5}}(#1,#3,#2)}}  % local supercycle violation condition at depth $d$
\newcommand{\locScViol}[5]{\ensuremath{\SMATHID{violLoc}_{\dsk{#4}{#5}}(#1,#3,#2)}}  % local supercycle violation condition at depth $d$
...
\newcommand{\lconnViol}[4]{\ensuremath{\SMATHID{sConnViolLoc}_{\dsk{#3}{#4}}(#1,#2)}}
\newcommand{\locConnViol}[4]{\ensuremath{\SMATHID{sConnViolLoc}_{\dsk{#3}{#4}}(#1,#2)}}

\newcommand{\WL}{\ensuremath{\MATHID{WL}}}
...
\newcommand{\locFormViol}[4]{\ensuremath{\SMATHID{genViolLoc}_{\dsk{#3}{#4}}(#1,#2)}}
\newcommand{\genLocViol}[4]{\ensuremath{\SMATHID{genViolLoc}_{\dsk{#3}{#4}}(#1,#2)}}
...
\newcommand{\SFs}[2]{\ensuremath{\CMATHIDN{S}_{#1}(#2)}}    % SF with subscripts
\newcommand{\SFsymb}{\ensuremath{\CMATHIDN{S}}}           % SF symbol with no args

\newcommand{\VF}[1]{\ensuremath{\CMATHIDN{V}(#1)}}   % fixpoint mapping for supercycle violation
\newcommand{\VFs}[2]{\ensuremath{\CMATHIDN{V}_{#1}(#2)}}  % VF with subscripts
\newcommand{\VFsi}[3]{\ensuremath{\CMATHIDN{V}_{#1}^{#3}(#2)}}   % VF with subscripts, and also with superscript for iteration
\newcommand{\VFi}[2]{\ensuremath{\CMATHIDN{V}^{#2}(#1)}}   % VF with no subscripts, but with superscript for iteration
\newcommand{\VFsymb}{\ensuremath{\CMATHIDN{V}}}  % VF symbol with no args


\newcommand{\blocks}[3]{\ensuremath{\MATHIDN{blocks}_{#1}(#2, #3)}}
...
\newcommand{\lSFs}[2]{\ensuremath{\CMATHIDN{SL}_{#1}(#2)}}           % SF symbol with subscripts
\newcommand{\lSFsymb}{\ensuremath{\CMATHIDN{SL}}}           % SF symbol with no args

\newcommand{\lVF}[1]{\ensuremath{\CMATHIDN{VL}(#1)}}   % fixpoint mapping for local supercycle violation
\newcommand{\lVFs}[2]{\ensuremath{\CMATHIDN{VL}_{#1}(#2)}}  % VF symbol with subscripts
\newcommand{\lVFsi}[3]{\ensuremath{\CMATHIDN{VL}_{#1}^{#3}(#2)}}   % lVF with subscripts, and with superscript for iteration
\newcommand{\lVFi}[2]{\ensuremath{\CMATHIDN{VL}^{#2}(#1)}}   % lVF with no subscripts, but with superscript for iteration

\newcommand{\lVFsymb}{\ensuremath{\CMATHIDN{VL}}}  % VF symbol with no args

\newcommand{\lblocks}[3]{\ensuremath{\MATHIDN{lblocks}_{#1}(#2, #3)}}
...
\newcommand{\TwR}{\mathit{TwR}}
\newcommand{\STR}{\mathit{STR}}
\newcommand{\STC}{\mathit{STC}}
\newcommand{\STT}{\mathit{STT}}
\newcommand{\RTR}{\mathit{RTR}}
\newcommand{\TTwR}{\mathit{TTwR}}
\newcommand{\RTT}{\mathit{RTT}}

\newcommand{\RM}{\mathit{RM}}
\newcommand{\RR}{\mathit{RR}}
\newcommand{\SR}{\mathit{SR}}
\newcommand{\RG}{\mathit{RG}}
...
\newcommand{\cLFP}[1]{\PNAME{Compute-LFP}(#1)}
\newcommand{\cVL}[1]{\PNAME{Compute-VL}(#1)}
\newcommand{\cLBL}[1]{\PNAME{Compute-LBlocks}(#1)}
...
\newcommand{\cLFV}[1]{\PNAME{GenLocViol}(#1)}
...
\newcommand{\get}{\MATHID{get}} % phil gets fork
\newcommand{\putt}{\MATHID{put}}  % phil puts fork down
\newcommand{\release}{\MATHID{put}}
\newcommand{\use}{\MATHID{use}}    % fork is used
\newcommand{\free}{\MATHID{free}}    % fork is freed

\newcommand{\Get}{\MATHID{Grab}} %redundant   
\newcommand{\Grab}{\MATHID{Grab}}   % Grab fork interaction
\newcommand{\Rel}{\MATHID{Rel}}     % Release fork interaction

\newcommand{\Phl}{\MATHID{Ph}}     % philosopher
...
\newcommand{\AND}{\ensuremath{\bigwedge}}
...
\newcommand{\ifof}{\equiv}                    % logical equivalence
\newcommand{\imp}{\Rightarrow}		% logical implication
\newcommand{\impliess}{\mathit{implies}}
...
\newcommand{\UNTIL}{\pseudocode{until}}
...
\newcommand{\ac}[1]{\textcolor{blue}{#1}}                     % color of interactions in figures
\newcommand{\Bc}[1]{\textcolor{red}{#1}}                    % color of components in figures



\newcommand{\vlo}{1}             %depth 1 sc violation in figures
\newcommand{\vlt}{2}             %depth 2 sc violation in figures
\newcommand{\vlh}{3}             %depth 3 sc violation in figures
\newcommand{\vlf}{4}             %depth 4 sc violation in figures
\newcommand{\vlv}{5}             %depth 5 sc violation in figures
