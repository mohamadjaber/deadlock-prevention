...
\noindent
The Connectors that connect ports in Figure~\ref{fig:diningbip} 
...
\redbox{
Intuitively, component $B_i$ in state $s$ enables at least one interaction $a$. 
...
$\rho \pj (\{P_0, P_1, F_0\}, Q'_0) = (h,h,f) \, \{P_0.get, F_0.use_l\} \, (e,h,u_l) \, \{P_0.release, F_0.free_l\} \, (h,h,f) \ldots$. In particular, we project the states and interactions with respect to the subcomponent. Notice that, interaction $get_2$ will disapear as its ports do not belong to the subcomponent.
