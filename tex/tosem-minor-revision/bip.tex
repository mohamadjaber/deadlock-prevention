...
\begin{definition}[Interaction] For a given BIP-system built from a set of $n$ atomic components 
...
%Let $(\B, Q_0)$ be a BIP system where $\B = \gamma(\B_1,\dots,\B_n)$, and 
Let $\set{\B_{i_1},\dots,\B_{i_k}}$ be a subset of $\set{\B_{1},\dots,\B_{n}}$.
