...
components. 
\redbox{
For example, state $e_i$ in atomic component $\Phl_i$ of Figure~\ref{fig:components} 
enables port $\putt_i$ as there exists a transition from $e_i$ labeled with
port $\putt_i$.} 
...
$(h_0,h_1,e_2,h_3,f_0,f_1,u_2^\l,u_3^r)$  \ldots
%, i.e., philosopher $P_0$ and $P_2$ gets their left and right forks, respectively, then $P_0$ releases its left and right forks. 
The projection of this execution on the sybsystem defined by subcomponent $\{\Phl_0, \Phl_1, F_0\}$, is equal to:
$\rho \pj (\{\Phl_0, \Phl_1, F_0\}, Q'_0) = (h_0,h_1,f_0) \, \{\get_0, \use_0^\l\} \, (e_0,h_1,u_0^\l) \, \{\putt_0, \free_0^\l\} \, (h_0,h_1,f_0) \ldots$
