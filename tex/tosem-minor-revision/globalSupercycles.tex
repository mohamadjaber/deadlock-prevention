...
\begin{figure*}[ht]
  \begin{center}
      \subfigure[Supercycle violations in initial state.]{\label{fig:wfg0}\scalebox{0.35}{\input{figs/scvDiningInitial.pdf_t}}} \quad \quad
      \subfigure[Supercycle violations after execution of $\Get_0$.]{\label{fig:wfg1}\scalebox{0.35}{\input{figs/scvDining1.pdf_t}}} 
      \subfigure[Supercycle violations after execution of $\Get_0 \Get_2$.]{\label{fig:wfg1}\scalebox{0.38}{\input{figs/scvDining2.pdf_t}}} \quad
      \subfigure[Supercycle violations after execution of $\Get_0 \Get_2 \Rel_0$.]{\label{fig:wfg1}\scalebox{0.38}{\input{figs/scvDining3.pdf_t}}} 
      \caption{Example supercycke violations for dining philosophers system of Figure~\ref{fig:diningSpectrum}.}
       \label{fig:wfg}
  \end{center}
\end{figure*}
