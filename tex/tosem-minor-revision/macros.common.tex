...
\newcommand{\US}{\MATHID{U}}
\newcommand{\VS}{\MATHID{V}}


\newcommand{\compl}[1]{\ensuremath{\MATHIDN{\overline{#1}}}}
...
\newcommand{\scV}[2]{\ensuremath{\SMATHID{scViolate}_{\B}(#1,#2)}} % overall supercycle violation 
\newcommand{\scVd}[3]{\ensuremath{\SMATHID{scViolate}_{\B}(#1,#2,#3)}} % supercycle violation at depth $d$
