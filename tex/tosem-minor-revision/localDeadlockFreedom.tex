...
Then $\tD \la{\act} \sD$ is a reachable transition of $\DS$ by \cor{bip.reachability}.
By $\LLin(\B, Q_0, \act, \l)$, 
$\widepth{\dsk{\act}{\l}}{\B_i}{\sD} < 2\l-1 \lor \wodepth{\dsk{\act}{\l}}{\B_i}{\sD} < 2\l-1$.
...
By the induction hypothesis applied to $d'$, we obtain $\locScViol{w}{d'+1}{\sD}{\act}{\l}$, and so $w \in \lVFsi{\sD}{\ewfg}{d'+1}$ by \defn{supercycle.local.violation}.
...
By \defn{violFix}, $v \in \lVFs{\sD}{\lVFsi{\sD}{\ewfg}{d}}$, \ie $v \in  \lVFsi{\sD}{\ewfg}{d+1}$.
By \defn{supercycle.violation}, $\locScViol{v}{1}{\sD}{\act}{\l}$.


%OLD
%Then, every outgoing wait-for edge of $v$ is to some $v'$ such that 
