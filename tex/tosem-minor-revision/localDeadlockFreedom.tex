...
\item $\SSC \not\subg \wfg{\dsk{a}{\l}}{t_\DS}$: then there exists a node $x \in \SSC - \wfg{\dsk{a}{\l}}{t_\DS}$.
...
Let $\ndv$ be an arbitrary node of $\dsk{\act}{\l}$ and $t_\DS$ be an arbitrary reachable state of $\dsk{\act}{\l}$.
