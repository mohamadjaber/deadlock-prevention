...
Let $\l > 0$ and $s_\act \goesto[\act] t_\act$ be a reachable transition of $\dsk{\act}{\l}$.
...
$(\B', Q'_0)$ be a subsystem of $(\B, Q_0)$ which is based on a superset of $\ssg{a}{\l}$.
...
$\wfg{\B'}{s'}$ is a subgraph of $\wfg{\B}{s}$.
%
Since $(\B', Q'_0)$ is based on a superset of $\ssg{a}{\l}$, and since the distance from $\B_i$ to the border of 
$\ssg{a}{\l}$ is $2\l-1$, we conclude that $\rho$ is a wait-for-path in $\wfg{\B'}{s'}$.
%
Hence 
