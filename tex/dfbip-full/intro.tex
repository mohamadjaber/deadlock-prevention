...
a subsystem is deadlocked while the rest of the system can execute. Other criteria in the literature \cite{AGR16,Ma96,RD87,DFinder2,BR91,MM12,GS03,AB03} guarantee only global deadlock.

This paper extends a preliminary conference version \cite{FORTE13} as
follows: 
...
(2) experimental results show that the new criterion is more efficient in practice, and also suceeds in cases where the linear criterion fails.
