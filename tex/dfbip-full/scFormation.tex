...
\item \label{prop:sc-membership:act-in}
...
%%%%%%%%%%%%%%
Proof of Clause~\ref{prop:sc-membership:act-out}.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%
Proof of Clause~\ref{prop:sc-membership:act-in}.  
%
...
contrapositive of Clause~\ref{prop:sc-membership:act-in}.  


%%%%%%%%%%%%%%%%%%%%%
Proof of Clause~\ref{prop:sc-membership:comp-out}.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
Proof of Clause~\ref{prop:sc-membership:comp-in}.
%
