...
\title{An Abstract Framework for Deadlock Prevention in BIP\thanks{The
    research leading to these results has received funding from
    University Research Board (URB) at AUB. Some of the results in
    this paper appeared at FORTE 2013, under the same titile.}
}
