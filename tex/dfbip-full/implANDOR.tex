...
\lio{\REPEAT \mbox{ until one of the following returns true, or run out of resources}}
...
\lio{\FORALLC{\mbox{maximal strongly connected components $C$}}}
   \lit{\mbox{\IF\ $C$ contains a strongly connected supercycle which contains $B_i$ as a node, \THEN\ \RETURNE{\fff} \FI}}
